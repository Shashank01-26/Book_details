...
//   Future<List<String>> fetchTitles() async {
//     final response = await http.get(
//         Uri.parse("https://openlibrary.org/search.json?q=Harry Potter"));
//     if (response.statusCode == 200) {
//       final Map<String, dynamic> jsonResponse = jsonDecode(response.body);
//       docs = jsonResponse['docs'];
...
//     final response = await http
//         .get(Uri.parse("https://openlibrary.org/search.json?q=test"));
//     if (response.statusCode == 200) {
//       final Map<String, dynamic> jsonResponse = jsonDecode(response.body);
//       docs = jsonResponse['docs'];
...
//               onPressed: () {
//                 showSearch(context: context, delegate: BookSearch(searchBooks,titles,docs));
//               }),
//         ],
